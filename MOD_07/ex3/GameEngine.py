...
#  Updated: 2026/03/25 20:38:48 by amamun          ###   ########.fr        #
#                                                                           #
# ************************************************************************* #
...
class GameEngine:
    ...
    def configure_engine(self, factory: CardFactory,
        ...
        deck: dict = self._factory.create_themed_deck(size=10)
        
        self._hand: list = deck['creatures'] + deck['spells'] + deck['artifacts']
    ...
    def simulate_turn(self) -> dict:
        ...
        turn_result:dict = self._strategy.execute_turn(
        ...
        for card_name in cards_played:
            ...
            if card_to_play:
                ...
                if hasattr(card_to_play, 'attack') and hasattr(card_to_play, 'health'):
