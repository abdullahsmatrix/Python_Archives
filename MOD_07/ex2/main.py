...
#  Updated: 2026/03/24 21:22:32 by amamun          ###   ########.fr        #
#                                                                           #
# ************************************************************************* #
...
def main() -> None:
    ...
    Card_methods: list = [method for method in Card.__dict__ if
                          not method.startswith("_")]
    Magical_methods: list = [method for method in Magical.__dict__ if
                          not method.startswith("_")]
    Combatable_methods: list = [method for method in Combatable.__dict__ if
                          not method.startswith("_")]
    ...
    Arcane_Warrior = EliteCard('Arcane Warrior', 4, "Legendary", 3, 5, 10, 8)
    print("Combat phase:")
