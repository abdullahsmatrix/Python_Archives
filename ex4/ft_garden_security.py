...
#  Updated: 2026/02/04 16:50:57 by amamun          ###   ########.fr        #
#                                                                           #
# ************************************************************************* #
...
class SecurePlant:
    ...
    def set_height(self, starting_height):
        if starting_height > 0:
            ...
            print(f"Invalid operation attempted: height {starting_height}cm [Rejected]")
            print("Security: Negative height rejected")
    def set_age(self, starting_age):
        if starting_age > 0:
            self.__starting_age = starting_age
        else:
            print(f"Invalid operation attempted: age {starting_age}cm [Rejected]")
