...
#  Updated: 2026/02/04 19:06:32 by amamun          ###   ########.fr        #
#                                                                           #
# ************************************************************************* #
...
class Tree(Plants):
    def __init__(self, name, age, height, trunk_diameter):
        ...
        print(f"{self.name} (Tree): {height}cm, {age} days, {trunk_diameter}cm diameter")
...
class Vegetables(Plants):
    def __init__(self, name, age, height, harvest_season, nutritional_value):
        ...
        print(f"{self.name} (Vegetable): {self.height}cm, {self.age} days, {self.harvest_season} season")
...
def main():
    ...
    mango.produce_shade()
    tomato = Vegetables("Tomato", 90, 80, "summer", "c")
    cabbage = Vegetables("Cabbage", 15, 20, "summer", "k")
